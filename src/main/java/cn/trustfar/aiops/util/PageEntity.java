...
public class PageEntity<T> implements Serializable {
    ...
    private int endRow = 0; // 当前页在数据库中的结束行
    ...
    public  static List getResultList(int startRow,int endRow ,List list){
    ...
    public  static List<JSONObject> getResultJsonList(int startRow,int endRow ,List<JSONObject> list){
